...
*(Added because it may not be apparent how Peano Arithmetic is present in reality.)*

Quick note: keep reading. The mapping below is not a category error — it is a demonstrable fact.
...
This is not abstract — it is how real quantum systems (photons, phonons, qubits in certain encodings) actually behave.
...
### 4. Induction (Base Case + Successor Step)
