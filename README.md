...
Coinduction / corecursion is also ruled out: the self-reference generated by the diagonal lemma is an instantiated recursive process, not a lazy, unevaluated coinductive definition. Once the system is self-referential in this way, it is recursive — you cannot have that self-reference without the recursion that produces it. {Establsihed math, if you deny this your denying diagonal lemma being a structural part of a gõdelian system}
