...
This is the central deductive chain of the proof:

**Disclaimer:**  
Substrate dependence is not a separate or standalone point — it applies to the entire proof. Every axiom and step that follows (including Gödel’s incompleteness theorems) is being applied to a system that is **physically instantiated** through quantum mechanics, not to an abstract or purely syntactic formal system. The structure described is real and physical. 
...
3. **Gödel’s incompleteness theorems apply to reality**  
   Because reality is a formal system containing Peano Arithmetic, both of Gödel’s incompleteness theorems apply directly to the physical universe.
