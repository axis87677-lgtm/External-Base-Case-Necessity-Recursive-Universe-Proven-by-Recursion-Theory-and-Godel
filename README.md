...
To deny this is to deny the external-base-case requirement of recursion theory after the system has already been shown to be self-referential. There is no other option left that meets the structural conditions.
